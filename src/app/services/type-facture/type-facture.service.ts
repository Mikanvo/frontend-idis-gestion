...
export class TypeFactureService {
  ...
  public getAllTypeFacture(): Observable<Array<TypeFacture>> {
  ...
  public searchTypeFacture(nomTypeFacture: string, enable: number, page: number, size: number): Observable<ListeTypeFacture> {
