...
export class FonctionService {
  ...
  public getAllFonctions(): Observable<Array<Fonction>> {
  ...
  public searchFonction(nomFonction: string, enable: number, page: number, size: number): Observable<ListeFonctions> {
