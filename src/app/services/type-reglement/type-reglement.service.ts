...
export class TypeReglementService {
  ...
  public getAllTypeReglement(): Observable<Array<TypeReglement>> {
  ...
  public searchTypeReglement(nomTypeReglement: string, enable: number, page: number, size: number): Observable<ListeTypeReglement> {
